...
function abrirModalModificarVisita() {
    const modalModificarVisita = document.getElementById('mmdal-modificar-venta');
    if (modalModificarVisita) {
        modalModificarVisita.style.display = 'block';
    }
}

function visualizarVisita(id) {
    const modalVisualizarVisitas = document.getElementById('modal-visualizar-visita');
    if (modalVisualizarVisitas) {
        modalVisualizarVisitas.style.display = 'block';
