...
document.getElementById("rol").addEventListener("change", function () {
    ...
    const campoInmueble = document.getElementById("campo-inmueble");
  
    if (rolSeleccionado === "propietario" || rolSeleccionado === "inquilino") {
      campoInmueble.style.display = "block";
      document.getElementById("inmueble").required = true;
    } else {
      campoInmueble.style.display = "none";
      document.getElementById("inmueble").required = false;
    }
  });
  
document.querySelector(".btn-agregar-inmueble").addEventListener("click", function (e) {
  e.preventDefault(); // Evita que se recargue el formulario si está dentro de uno

  const extraField = document.getElementById("inmueble-extra");

  if (extraField.style.display === "none") {
    extraField.style.display = "block";
  } else {
    // Opcional: si querés que se oculte de nuevo al hacer clic otra vez
    // extraField.style.display = "none";
  }
});
let contadorInmuebles = 1;
...
document.querySelector(".btn-agregar-inmueble").addEventListener("click", function (e) {
  ...
  nuevoInput.className = "inmueble-input";
  nuevoInput.name = "inmueble";
